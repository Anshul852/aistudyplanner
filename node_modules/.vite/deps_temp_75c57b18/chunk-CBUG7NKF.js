  ...
  return new Proxy(
    ...
    value,
    {
      ...
      get(target, prop, receiver) {
        ...
        if (s === void 0 && (!exists || ((_a3 = get_descriptor(target, prop)) == null ? void 0 : _a3.writable))) {
          s = with_parent(() => {
      ...
      has(target, prop) {
        ...
        if (s !== void 0 || active_effect !== null && (!has || ((_a3 = get_descriptor(target, prop)) == null ? void 0 : _a3.writable))) {
          if (s === void 0) {
            s = with_parent(() => {
      ...
      set(target, prop, value2, receiver) {
        ...
        if (s === void 0) {
          if (!has || ((_a3 = get_descriptor(target, prop)) == null ? void 0 : _a3.writable)) {
...
function get_adjustments(error, effect) {
  ...
  var component_stack = `
${indent}in ${((_a3 = effect.fn) == null ? void 0 : _a3.name) || "<unknown>"}`;
...
var _anchor, _hydrate_open, _props, _children, _effect, _main_effect, _pending_effect, _failed_effect, _offscreen_fragment, _local_pending_count, _pending_count, _pending_count_update_queued, _dirty_effects2, _maybe_dirty_effects2, _effect_pending, _effect_pending_subscriber, _Boundary_instances, hydrate_resolved_content_fn, hydrate_pending_content_fn, render_fn, resolve_fn, run_fn, update_pending_count_fn;
var Boundary = class {
  /**
...
function handle_event_propagation(event) {
  ...
  var path = ((_a3 = event.composedPath) == null ? void 0 : _a3.call(event)) || [];
  var current_target = (
    /** @type {null | Element} */
    path[0] || event.target
  );
  ...
  try {
    ...
    while (current_target !== null) {
      ...
      try {
        var delegated = (_b = current_target[event_symbol]) == null ? void 0 : _b[event_name];
...
//# sourceMappingURL=chunk-CBUG7NKF.js.map
