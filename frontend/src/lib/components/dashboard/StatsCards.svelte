        ...
        stats = [
            {
                ...
                value: formatValue(
                    "Sessions",
                    data.total_sessions ?? data.study_sessions ?? 47,
                ),
                raw: data.total_sessions ?? data.study_sessions ?? 47,
                max: 100,
                trend: data.sessions_trend ?? "+12%",
                trendUp: true,
                accent: "#a3e635",
                glow: "rgba(163,230,53,0.15)",
            },
            {
                ...
                value: formatValue(
                    "Focus",
                    data.focus_hours ?? data.total_focus_hours ?? 127,
                ),
                raw: data.focus_hours ?? data.total_focus_hours ?? 127,
                max: 200,
                trend: data.focus_trend ?? "+8%",
                trendUp: true,
                accent: "#38bdf8",
                glow: "rgba(56,189,248,0.15)",
            },
            {
                ...
                value: formatValue(
                    "Goal",
                    data.weekly_goal_pct ?? data.weekly_goal ?? 75,
                ),
                raw: data.weekly_goal_pct ?? data.weekly_goal ?? 75,
                max: 100,
                trend: data.goal_trend ?? "+5%",
                trendUp: true,
                accent: "#f59e0b",
                glow: "rgba(245,158,11,0.15)",
            },
            {
                ...
                value: formatValue(
                    "Retention",
                    data.retention_rate ?? data.retention ?? 89,
                ),
                raw: data.retention_rate ?? data.retention ?? 89,
                max: 100,
                trend: data.retention_trend ?? "+3%",
                trendUp: true,
                accent: "#e879f9",
                glow: "rgba(232,121,249,0.15)",
            },
