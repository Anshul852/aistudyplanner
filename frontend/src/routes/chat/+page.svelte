    ...
    try {
      await processMessage({
        ...
        onChunk: (chunk: string) => {
          // Streamer will handle updating the store
        },
        onComplete: () => {
          isTyping = false;
        },
...
{#if loading}
  <div class="loading-overlay">
    <div class="loading-inner">
      ...
      <p class="loading-text">Initializing AI Chat</p>
  ...
  <header class="page-header">
    <div class="header-left">
      ...
      <div>
        ...
        <p class="page-sub">Intelligent study assistant with classical algorithms</p>
      </div>
    </div>
    <div class="header-actions">
      ...
      <button class="accent-btn" on:click={clearChat}>
    ...
    <div class="conversation-list">
      ...
      <div class="conversation-item active">
        ...
        <div class="conversation-content">
          <div class="conversation-title">StudyVault AI Chat</div>
    ...
    <div class="context-panel">
      ...
      <div class="context-content">
        ...
        <div class="context-section">
          <div class="section-header">
            <span class="section-dot" />
            <h3 class="section-title">Current Subject</h3>
          </div>
          <div class="context-item">
...
<style>
  ...
  .loading-overlay {
    ...
    animation: fade-out 300ms ease 750ms forwards;
  }
  .loading-inner {
    display: flex;
